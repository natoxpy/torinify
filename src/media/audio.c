...
//         dec_ctx,
//         file_ctx->fmt_ctx->streams[file_ctx->stream_index]->codecpar);
//
...
//                 } else if (ret < 0) {
//                     av_log(NULL, AV_LOG_ERROR,
//                            "Error while receiving a frame from the
//                            decoder\n");
//                     return ret;
//                 }
//
...
//
//                     cl_rawdata_append(decoded_file->data, output_buffer,
//                     size);
//
